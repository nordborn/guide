...
Стили - это соглашения, которые управляют нашим кодом. 
Термин стиль - недостаточно точное название, так как подобные соглашения охватывают гораздо больше, 
чем просто вопросы форматирования кода (которое gofmt и так делает для нас).

<!-- The goal of this guide is to manage this complexity by describing in detail the
Dos and Don'ts of writing Go code at Uber. 
These rules exist to keep the code base manageable while still 
allowing engineers to use Go language features
productively. -->

Цель данного руководства состоит в том, чтобы помочь управлять сложностью разработки 
путем подробного описания того "как надо" и "как не надо" делать 
...
1. Указатель на специфичную для хранящегося типа информацию. Вы можете думать об этом как
  "тип".
...
> следите за тем, что передаете: значение или указатель. 
...
// легко можно забыть снять блокировку 
// из-за нескольких точек возврата
```
